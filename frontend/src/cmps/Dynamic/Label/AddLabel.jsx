...
export function AddLabel({ pos, onCloseEditTask, onAddLabel, labelToEdit, onSaveTask, task, setCheckedLabelsStart, onDeletingLabel }) {
    ...
    const labelsColorPickers = ['#baf3db', '#f8e6a0', '#ffe2bd', '#ffd2cc', '#dfd8fd', '#4bce97', '#e2b203', '#faa53d',
        '#f87462', '#9f8fef', '#1f845a', '#946f00', '#b65c02', '#ca3521', '#6e5dc6', '#cce0ff', '#c1f0f5', '#D3F1A7',
        '#fdd0ec', '#dcdfe4', '#579dff', '#60c6d2', '#94c748', '#e774bb', '#8590a2', '#0c66e4', '#1d7f8c', '#5b7f24', '#ae4787', '#626f86',]
    ...
    async function onSaveLabel() {
        ...
        try {
            ...
            console.error('Cannot save label', err)
            throw err
        }
