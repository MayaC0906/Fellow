...
export function AddBoard({ setIsBoardAdded }) {
    ...
    // const backgroundColors = ['rgb(239, 118, 58)', 'rgb(168, 105, 193)']
        ...
        <section style={{ border: '1px solid black', bottom: '400px' }} className="edit-modal">
            ...
            <section className="edit-modal-content">
                <div className="content">
                    <section style={{ backgroundImage: `url(${backGroundgImg})` }} className="board-display">
            ...
            {isBoardAdded && <Link to={`/board/${board._id}`}></Link>}
        </section>
    )
}